...
export default function ProductDetail() {
  ...
  const { data: productDetailData } = useQuery({
    queryKey: ['product', id],
    queryFn: () => productApi.getProductsDetail(id)
  })
            ...
            <div className='col-span-5'>
              ...
              >
                <img
                  src={activeImage}
                  alt={product.name}
                  className='absolute pointer-events-none top-0 left-0 bg-white w-full h-full'
                  ref={imageRef}
                />
              </div>
                  ...
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => chooseActive(img)}>
                      <img
                        src={img}
                        alt={product.name}
                        className='absolute top-0 left-0 bg-white w-full h-full cursor-pointer'
                      />
                      {isActive && <div className='absolute inset-0 border-2 border-cyan-400'></div>}
                    </div>
                  )
                })}
                <button
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  <span className='mr-1 border-b border-b-cyan-500 text-cyan-500'>{product.rating}</span>
              ...
              <div className='mt-8 flex items-center bg-gray-50 py-4'>
                ...
                <div className='ml-3 text-3xl font-medium text-cyan-500'>₫{formatCurrency(product.price)}</div>
                <div className='ml-4 rounded-sm bg-cyan-500 px-1 py-[2px] text-xs font-semibold uppercase text-white'>
